...
/**
  * A generic RPC which is handled by a remote [[RpcHandler]].
  * This will correspond to a single [[ResponseMessage]]} (either success or failure).
  */
class RpcRequest(val requestId: Long, private val message: ByteBuf) extends RequestMessage {
  /** Used to identify this request type. */
  override def `type`: MessageType = MessageType.RpcRequest
