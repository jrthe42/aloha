...
/**
  * A response to a submit request in the REST application submission protocol.
  */
private[aloha] class CreateSubmissionResponse extends SubmitRestProtocolResponse {
...
/**
  ...
  */
private[aloha] class KillSubmissionResponse extends SubmitRestProtocolResponse {
  var submissionId: String = null
  protected override def doValidate(): Unit = {
    super.doValidate()
...
/**
  ...
  */
private[aloha] class SubmissionStatusResponse extends SubmitRestProtocolResponse {
  var submissionId: String = null
