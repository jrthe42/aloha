...
import me.jrwang.aloha.scheduler.master.{LeaderElectable, LeaderElectionAgent, PersistenceEngine, StandaloneRecoveryModeFactory}
import me.jrwang.aloha.rpc.serializer.Serializer

private[master] class ZooKeeperRecoveryModeFactory(
    conf: AlohaConf, serializer: Serializer)
