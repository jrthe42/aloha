...
import me.jrwang.aloha.common.{AlohaConf, config}
...
/**
  ...
  * @param conf                    AlohaConf that is used to pass on extra configurations
  * @param bufferSize              Optional buffer size. Used mainly for testing.
  */
private[aloha] class RollingFileAppender(
...
/**
  * Companion object to [[RollingFileAppender]]. Defines
  * names of configurations that configure rolling file appenders.
  */
private[aloha] object RollingFileAppender {
